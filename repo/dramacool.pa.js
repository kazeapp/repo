...
// @pkg          dramacool.pa
// @type         movies
// @webSite      https://dramacool.pa
// @baseUrl      https://proxy.techzbots1.workers.dev/?u=https://nontan-source-kgw9jch3s-imkryp70n.vercel.app/movies/dramacool
// ==/KazeExtension==
...
export default class extends Extension {
  ...
  async load() {
    this.registerSetting({
      ...
      defaultValue:
        "https://proxy.techzbots1.workers.dev/?u=https://nontan-source-kgw9jch3s-imkryp70n.vercel.app/movies/dramacool",
    });
  }
  ...
  async latest() {
    const res = await this.request("", {
      headers: {
        "Kaze-Url":
          "https://proxy.techzbots1.workers.dev/?u=https://dramacool.pa/most-popular-drama",
      },
    });
